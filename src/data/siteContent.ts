...
const solainoCaptions = [
  'Acceso al sistema: inicio de sesión con roles controlados, “recordarme”, recuperación de contraseña y prueba de conexión a Supabase (backend en la nube).',
  'Panel administrador: hub de módulos (Inventario, Bodega, Producción), conteo de usuarios/clientes/requisitores y estado en vivo de la sesión y de Supabase.',
  'Inventario (resumen): indicadores Sin stock / Por terminarse / OK, alertas operativas y búsqueda; existencias sincronizadas en la nube para todos los equipos.',
  'Listado de productos: catálogo técnico (p. ej. cortadores de carburo) con código, medida, ubicación, mínimos, costos, miniaturas y acciones de historial/edición.',
  'Ajuste de inventario: corrección de stock por conteo o error, con motivo, nota y aviso cuando el producto usa control por número de serie.',
  'Registrar entrada: alta de existencias por código o serie (escaneo), carrito multi-línea y pegado masivo de series para recepción en almacén.',
  'Embarque / salida: descuento de existencias con lógica FIFO, selección de series concretas y validación contra stock disponible.',
  'Alta de producto: captura de identificación (código, medida, código de fabricante) y ubicación física (área / estante) en el almacén principal.',
  'Solicitudes de inventario: seguimiento de pedidos internos (pendiente/atendido), cantidades vs stock y acciones por fila para operación de bodega.',
  'Usuarios: cuentas con roles (operador, encargado, programadora de maquinaria, admin) y gestión de recuperación de contraseña.',
  'Historial (auditoría): selección de usuario para revisar actividades de inventario y solicitudes con trazabilidad por rol.',
  'Historial por usuario: bitácora de cambios en proyectos de bodega (estados en programación / revisión y avance %), útil para seguimiento de taller y CNC.',
  'Bodega: órdenes de compra por cliente (p. ej. FLEX, JABIL) y menú de flujo (proyectos, archivos, maquinado CNC/torno, taller de perfilado, detallado y armado).',
] as const
...
export const content: Record<Locale, SiteContent> = {
  es: {
    ...
    about: [
      ...
      'He participado en proyectos gubernamentales y empresariales de punta a punta: levantamiento de necesidades, modelado de datos, frontend y backend, pruebas, documentación y acompañamiento al despliegue. En entorno industrial (Solaino) también apoyo procesos de manufactura: CNC, programación en Fusion, fixtures y retrabajo en taller.',
    ...
    projects: [
      {
        id: 'solaino',
        title: 'Sistemas de inventario, bodega y producción (Solaino)',
        org: 'Solaino Soluciones Integrales',
        period: '2025 — presente',
        summary:
          'Participación integral en Solaino: desarrollo de software interno para inventario, bodega y producción (con Supabase/PostgreSQL), y apoyo en piso de manufactura — programación CNC en Autodesk Fusion, maquinado de fixtures, armado, detallado y retrabajo de piezas.',
        highlights: [
          'Desarrollo full stack de un sistema web de operación diaria: autenticación por roles, panel administrador, inventario con alertas de stock, listado técnico de productos (herramientas/cortadores), ajustes, entradas/salidas con control por serie y lógica FIFO, solicitudes internas, usuarios e historial de auditoría.',
          'Módulo de bodega orientado a clientes y órdenes de compra (p. ej. FLEX, JABIL): seguimiento de proyectos por etapas (diseño, programación, maquinado, taller), adjuntos, reportes de tiempos/avance y cola de maquinado CNC/torno por pieza.',
          'En taller y CNC: programación de trayectorias en Autodesk Fusion, maquinados para fixtures, y apoyo en armar, detallar y retrabajar piezas — cerrando el ciclo entre el sistema digital y la fabricación real.',
          'Diseño de flujos para centralizar existencias, movimientos y responsables en la nube (Supabase), reduciendo ambigüedad frente a hojas de cálculo y mejorando trazabilidad para administración y piso.',
          'Entregas iterativas con retroalimentación del equipo operativo: reglas de negocio (mínimos, series, roles como programadora de maquinaria) y vistas pensadas para uso real en almacén y producción.',
        ],
        stack: [
          'React',
          'Vite',
  ...
  en: {
    ...
    about: [
      ...
      'I have contributed end-to-end on government and enterprise projects: requirements, data modeling, frontend and backend, testing, documentation, and rollout support. In an industrial setting (Solaino) I also support manufacturing: CNC, Fusion programming, fixtures, and shop-floor rework.',
    ...
    projects: [
      {
        id: 'solaino',
        title: 'Inventory, warehouse, and production systems (Solaino)',
        org: 'Solaino Soluciones Integrales',
        period: '2025 — present',
        summary:
          'End-to-end work at Solaino: building internal software for inventory, warehouse, and production (Supabase/PostgreSQL), plus shop-floor support — CNC programming in Autodesk Fusion, fixture machining, and assembling, detailing, and reworking parts.',
        highlights: [
          'Full-stack web system for daily operations: role-based auth, admin hub, inventory with stock alerts, technical product catalog (tools/cutters), adjustments, inbound/outbound with serial control and FIFO, internal requests, users, and audit history.',
          'Warehouse module driven by clients and purchase orders (e.g. FLEX, JABIL): project stages (design, programming, machining, shop), attachments, time/progress reports, and a CNC/lathe queue per part.',
          'On the shop floor and CNC: toolpath programming in Autodesk Fusion, machining fixtures, and hands-on support assembling, detailing, and reworking parts — bridging the digital system and real manufacturing.',
          'Flows that centralize stock, movements, and ownership in the cloud (Supabase), reducing spreadsheet ambiguity and improving traceability for admin and the floor.',
          'Iterative delivery with operator feedback: business rules (minimums, serials, roles such as machinery programmer) and screens built for real warehouse and production use.',
        ],
        stack: [
          'React',
          'Vite',
