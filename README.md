...
Añade los PNG en `public/media/alch/` (`1.png` … `12.png`), `public/media/cruz-verde/` (`1.png` … `4.png`) y **`public/media/solaino/`** (`1.png` … `13.png`); detalle en `public/media/README.md`.
